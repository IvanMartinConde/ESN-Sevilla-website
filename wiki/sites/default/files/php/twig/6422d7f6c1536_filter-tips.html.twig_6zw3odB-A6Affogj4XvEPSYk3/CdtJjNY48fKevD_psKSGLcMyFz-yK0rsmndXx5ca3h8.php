...
class __TwigTemplate_07d775118796140645238753327e5925 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/bartik/templates/classy/content-edit/filter-tips.html.twig", "/var/www/vhosts/esnsevilla.org/public_html/core/themes/bartik/templates/classy/content-edit/filter-tips.html.twig");
    }
