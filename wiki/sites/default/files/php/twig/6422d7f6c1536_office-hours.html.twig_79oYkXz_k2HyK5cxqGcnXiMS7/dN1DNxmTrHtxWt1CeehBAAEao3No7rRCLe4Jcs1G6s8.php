...
class __TwigTemplate_b314e52c0621fe2ec5ddec679b1c8f8086c6f1176ad97fe2367a6bc0133af56d extends \Twig\Template
{
    private $source;
    private $macros = [];
  ...
  ";
      ...
      ";
            ...
            if (twig_get_attribute($this->env, $this->source, $context["item"], "label", [], "any", false, false, true, 4)) {
                ...
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, (($context["label_length"] ?? null) * 0.59999999999999997779553950749686919152736663818359375), "html", null, true);
                echo "em;\">";
